        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          <div>
            ...
            <p className="text-xs sm:text-sm text-[#8B93A1] mt-4 max-w-xl">
              Directly connected to ApplyNow for swift dossier transmission, verified requirements, and automated status updates.
            </p>
          </div>

          <button
            onClick={() => navigate("/auth?mode=signin")}
            className="text-xs sm:text-sm font-medium text-[#E8792E] hover:text-[#C96A28] transition flex items-center gap-2 cursor-pointer self-start sm:self-auto"
          >
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-[11px] font-mono text-[#E8792E] bg-[#F5E6D8] px-2 py-0.5 rounded font-medium">
                ...
                <h4 className="text-base font-semibold text-[#1F2430] group-hover:text-[#E8792E] transition-colors line-clamp-2">
                  {uni.name}
                </h4>
